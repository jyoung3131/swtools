...
alias condesa='ssh -X jyoung9@condesa.cc.gt.atl.ga.us'
#ORNL and other clusters
alias excl='ssh -X excl.ornl.gov'
alias rhea='ssh -X jyoung@rhea.ccs.ornl.gov'
alias titan='ssh -X jyoung@home.ccs.ornl.gov'
alias rhea='ssh -X jyoung@rhea.ccs.ornl.gov'
alias wombat='ssh -X jyoung9@wombat-login1.ccs.ornl.gov'
...
alias rgneurohost='ssh -X jyoung9@rg-neuro-host.crnch.gatech.edu'
